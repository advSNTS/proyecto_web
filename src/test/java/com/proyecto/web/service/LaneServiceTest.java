...
class LaneServiceTest {
    ...
    void listarPorPool_deberiaRetornarSoloLanesDelRolDelEmpleado() {
        ...
        when(poolRepository.findByIdAndEmpresa_NitAndEliminadoFalse(10L, "NIT-001"))
        ...
        List<LaneResponseDTO> result = laneService.listarPorPool("NIT-001", 10L);
    ...
    @Test
    void obtener_deberiaLanzar404CuandoLaneNoEsVisible() {
        ...
        when(rolXEmpleadoRepository.findAllByEmpleado_IdAndDeletedFalse(100L))
                .thenReturn(List.of(asignacion));
        when(laneRepository.findByIdAndPool_Empresa_NitAndEliminadoFalseAndRolProceso_IdIn(1L, "NIT-001", List.of(7L)))
    ...
    void crear_deberiaRechazarLaneSinRolProceso() {
        ...
        BusinessException ex = assertThrows(BusinessException.class, () -> laneService.crear("NIT-001", dto));
